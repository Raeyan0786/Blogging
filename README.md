...
This project is a basic web application that allows users for Blogging  and manage their profile information. Additionally, users can create posts and view posts created by other users. 
